...
class SliderComponent extends HTMLElement {
  ...
  setAutoPlay() {
    if(window.matchMedia("(min-width: 750px)").matches){
      this.autoplaySpeed = this.slider.getAttribute('data-speed-desktop') * 3000;
    }else{
      this.autoplaySpeed = this.slider.getAttribute('data-speed-mobile') * 3000;
    }
    this.play();
  }
...
class SlideshowComponent extends SliderComponent {
  ...
  setAutoPlay() {
    this.autoplaySpeed = this.slider.dataset.speed * 1200;
